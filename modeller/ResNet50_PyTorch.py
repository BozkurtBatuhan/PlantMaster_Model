...
for epoch in range(num_epochs):
    ...
    if val_loss < best_val_loss:
        ...
        torch.save(model.state_dict(), 'best_plant_disease_model_resnet.pth')
        print("Best model saved.")

    scheduler.step()

model.load_state_dict(torch.load('best_plant_disease_model_resnet.pth'))
...
plt.legend()
plt.savefig('loss_graph_resnet.png')
plt.show()
...
plt.legend()
plt.savefig('accuracy_graph_resnet.png')
plt.show()
